...
<CardGroup cols={2}>
  <Card title="Sincronización automática" icon="arrows-rotate" href="/how-it-works">
    Cuando baneas a alguien en tu servidor, se registra solo en la base compartida.
  </Card>
  <Card title="Alertas al staff" icon="triangle-exclamation" href="/alerts">
    Si entra alguien con baneos en otras comunidades, tu equipo recibe un aviso en el canal que
    elijas.
  </Card>
  <Card title="Auto-ban opcional" icon="gavel" href="/auto-ban">
    Expulsa automáticamente a quien acumule demasiados baneos. Desactivado por defecto.
  </Card>
  <Card title="Origen siempre anónimo" icon="user-secret" href="/privacy">
